...
subtitle: "Модель хищник-жертва - вариант 45"
...
$$
 \begin{cases}
	\frac{dx}{dt} = -0.32x(t) + 0.04y(t)x(t)
	\\   
	\frac{dy}{dt} = 0.42y(t) - 0.02y(t)x(t)
 \end{cases}
$$

Постройте график зависимости численности хищников от численности жертв, а также графики изменения численности хищников и численности жертв 
при следующих начальных условиях: $x_0=9, y_0=20$
...
Стационарное состояние $x_0=\frac{a}{b}=8, y_0=\frac{c}{d}=21$
